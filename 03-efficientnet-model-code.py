...
from keras.applications.efficientnet_v2 import preprocess_input, EfficientNetV2M
...
MODEL_SAVE_PATH = "final-efficientnetv2m-tfrecord.keras"
...
IMAGE_SIZE = (384, 384) # Larger size works well for EfficientNet
BATCH_SIZE = 32 # EfficientNetV2-M is large, so a slightly smaller batch size is safer
EPOCHS = 50
SEED = 123
...
print("--- Configuring GPU for EfficientNetV2-M Training ---")
...
with tf.device('/gpu:0'):
    ...
    base_model = EfficientNetV2M(include_top=False, weights="imagenet", input_shape=(*IMAGE_SIZE, 3))
...
plt.title('Confusion Matrix - EfficientNetV2-M')
plt.ylabel('True Label'); plt.xlabel('Predicted Label')
plt.savefig('efficientnetv2m_confusion_matrix.png')
print("\n✅ Confusion matrix saved to efficientnetv2m_confusion_matrix.png")