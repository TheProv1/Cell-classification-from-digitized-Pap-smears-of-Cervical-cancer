...
MODEL_SAVE_PATH = "final-resnet50v2-tfrecord.keras"
...
print("--- Configuring GPU for ResNet50V2 Training ---")
...
plt.savefig('resnet50v2_confusion_matrix.png')
print("\n✅ Confusion matrix saved to resnet50v2_confusion_matrix.png")