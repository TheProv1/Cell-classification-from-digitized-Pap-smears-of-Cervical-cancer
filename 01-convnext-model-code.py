...
from keras.applications.convnext import preprocess_input, ConvNeXtSmall
...
MODEL_SAVE_PATH = "final-convnextsmall-tfrecord.keras"
...
print("--- Configuring GPU for ConvNeXt-Small Training ---")
...
with tf.device('/gpu:0'):
    ...
    base_model = ConvNeXtSmall(include_top=False, weights="imagenet", input_shape=(*IMAGE_SIZE, 3))
...
plt.title('Confusion Matrix - ConvNeXt-Small')
plt.ylabel('True Label'); plt.xlabel('Predicted Label')
plt.savefig('convnextsmall_confusion_matrix.png')
print("\n✅ Confusion matrix saved to convnextsmall_confusion_matrix.png")