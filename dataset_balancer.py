...
# --- Configuration ---
# ABSOLUTE path to the main data folder (where the 'training' folder lives)
DATASET_DIR = "/home/Tojo/papsmear"
TRAIN_IMAGE_DIR = os.path.join(DATASET_DIR, "training")

# RELATIVE path for the CSV file. Reads 'train.csv' from your current working directory.
CSV_PATH = 'train.csv'

# --- Augmentation Pipeline ---
# This pipeline is used to generate new, diverse images.
augmentation_pipeline = A.Compose([
    # --- Geometric Augmentations (SAFE) ---
    # These mimic changes in cell orientation and position on the slide.
    ...
    # --- Appearance Augmentations (USE WITH CAUTION) ---
    # Mild brightness/contrast changes are acceptable to simulate different lighting.
    A.RandomBrightnessContrast(brightness_limit=0.1, contrast_limit=0.1, p=0.5),

    # AVOID heavy color augmentations like HueSaturationValue, ChannelShuffle, etc.
    # The stain color is a critical feature.

    # --- Noise/Blur (SAFE) ---
    # Simulates minor variations in microscope focus or camera noise.
