...
# NOTE: The script originally specified NASNetLarge's image size (331) but used NASNetMobile.
# Using the correct size for NASNetMobile.
IMAGE_SIZE = (224, 224)
