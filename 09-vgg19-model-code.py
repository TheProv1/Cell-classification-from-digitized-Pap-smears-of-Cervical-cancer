...
MODEL_SAVE_PATH = "final-vgg19-tfrecord.keras"
...
print("--- Configuring GPU for VGG19 Training ---")
...
with tf.device('/gpu:0'):
    ...
    base_model = VGG19(include_top=False, weights="imagenet", input_shape=(*IMAGE_SIZE, 3))
...
print("\n✅ Confusion matrix saved to vgg19_confusion_matrix.png")