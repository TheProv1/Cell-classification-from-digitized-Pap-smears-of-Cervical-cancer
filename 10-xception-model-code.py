...
MODEL_SAVE_PATH = "final-xception-tfrecord.keras"
...
print("--- Configuring GPU for Xception Training ---")
...
with tf.device('/gpu:0'):
    ...
    base_model = Xception(include_top=False, weights="imagenet", input_shape=(*IMAGE_SIZE, 3))
...
print("\n✅ Confusion matrix saved to xception_confusion_matrix.png")