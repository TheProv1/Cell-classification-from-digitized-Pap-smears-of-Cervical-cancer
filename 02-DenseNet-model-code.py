...
MODEL_SAVE_PATH = "final-densenet121-tfrecord.keras"
...
print("--- Configuring GPU for DenseNet-121 Training ---")
...
print("\n✅ Confusion matrix saved to densenet121_confusion_matrix.png")